...
static void TrimRight(char *pString, char UnwantedChar)
{
...
//static void si468x_load_service_name_list_from_flash(uint16_t memory_index);
static DAB_Service_List *si468x_DAB_decode_digital_service_list(uint8_t *service_list_data, uint8_t freq_index);
static DAB_Service_List *si468x_DAB_get_digital_service_list(uint8_t freq_index);
...
//	HAL_Delay(5000); // JSB: !!!???
//
//	si468x_read_response(read_buffer, 50); // !!!JSB?
//	// uint8_t num_user_applications = read_buffer[26];
